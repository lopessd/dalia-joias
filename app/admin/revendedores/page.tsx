      ...
      <main className="flex-1 md:ml-64 p-4 md:p-8 pt-16 md:pt-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
              <h1 className="text-3xl font-heading text-foreground mb-2">Gestão de Revendedores</h1>
              <p className="text-muted-foreground font-body">Controle completo dos revendedores e suas atividades</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card className="border-border">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-body text-muted-foreground">Total de Revendedores</CardTitle>
                <Users className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-heading text-foreground">{totalRevendedores}</div>
                <p className="text-xs text-muted-foreground font-body">revendedores cadastrados</p>
              </CardContent>
            </Card>

            <Card className="border-border">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-body text-muted-foreground">Revendedores Ativos</CardTitle>
              ...
              <CardContent>
                ...
                <p className="text-xs text-green-600 font-body">
                  {((revendedoresAtivos / totalRevendedores) * 100).toFixed(0)}% do total
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-body text-muted-foreground">Peças com Revendedores</CardTitle>
            ...
            <Card className="border-border">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-body text-muted-foreground">Valor Distribuído</CardTitle>
                <TrendingUp className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-heading text-foreground">{formatCurrency(valorTotalComRevendedores)}</div>
                <p className="text-xs text-muted-foreground font-body">valor total em peças</p>
              </CardContent>
            </Card>
          </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1 space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      id="search"
                      placeholder="Digite o nome ou email do revendedor..."
                      value={searchTerm}
          ...
          {filteredRevendedores.length === 0 && (
            <Card className="border-border">
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <h3 className="text-lg font-heading text-foreground mb-2">Nenhum revendedor encontrado</h3>
                <p className="text-muted-foreground font-body text-center">
                  {searchTerm
                    ? "Tente ajustar o termo de busca ou criar um novo revendedor."
                    : "Comece criando seu primeiro revendedor."}
                </p>
              </CardContent>
            </Card>
          )}
